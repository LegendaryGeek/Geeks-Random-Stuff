...
public class FoodInfuser extends BlockContainer {
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	private final boolean isInfusing;
	private static boolean keepInventory;

	public FoodInfuser(boolean isInfusing) {
		super(Material.ROCK);
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
		...
		if (stack.hasDisplayName()) {
			...
			if (tileentity instanceof TEFoodInfuser) {
				((TEFoodInfuser) tileentity).setCustomInventoryName(stack.getDisplayName());
			}
		}
	}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		if (!keepInventory) {
			...
			if (tileentity instanceof TEFoodInfuser) {
				InventoryHelper.dropInventoryItems(worldIn, pos, (TEFoodInfuser) tileentity);
